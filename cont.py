...
# Gerekli kütüphaneleri içe aktarma hatasına karşı koruma:
try:
    from zoneinfo import ZoneInfo
except ImportError:
    # Eğer zoneinfo Python'da yoksa (eski sürümler), backports.zoneinfo'yu kullanır.
    # Bunun için 'backports.zoneinfo' paketinin requirements.txt'de olması gerekir.
